  ...
  <h1>We&apos;d Love to Hear From You</h1>
      ...
      <div className="contact-feedback-content-container">
        <section className="contact-feedback-section">
          ...
          <form>
            <div className="contact-feedback-form-group">
              <label htmlFor="name" className="contact-feedback-label">
                <FaUser /> Name:
              </label>
            ...
            <div className="contact-feedback-form-group">
              <label htmlFor="email" className="contact-feedback-label">
                <FaEnvelope /> Email:
              </label>
            ...
            <div className="contact-feedback-form-group">
              <label htmlFor="message" className="contact-feedback-label">
                <FaCommentDots /> Message:
              </label>
              <textarea id="message" name="message" placeholder="Your Message" required className="contact-feedback-textarea" />
            </div>

            <button type="submit" className="contact-feedback-button">
              Send Message
            </button>
          </form>
        </section>
        ...
        <section className="feedback-section">
          ...
          <form>
            <div className="contact-feedback-form-group">
              <label htmlFor="rating" className="contact-feedback-label">
                <FaStar /> Rate Us:
              </label>
            ...
            <div className="contact-feedback-form-group">
              <label htmlFor="feedback" className="contact-feedback-label">
                <FaCommentDots /> Your Feedback:
              </label>
              <textarea id="feedback" name="feedback" placeholder="Your Feedback" required className="contact-feedback-textarea" />
            </div>
