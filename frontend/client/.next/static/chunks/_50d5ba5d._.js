...
"[project]/src/app/pages/contexts/CartContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CartContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(defaultContext);
const getStorage = ()=>("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : window.localStorage;
const decodeToken = ()=>{
    ...
    try {
        var _token_split_;
        const payload = JSON.parse(atob((_token_split_ = token.split(".")[1]) !== null && _token_split_ !== void 0 ? _token_split_ : ""));
        return (payload === null || payload === void 0 ? void 0 : payload.id) || (payload === null || payload === void 0 ? void 0 : payload.userId) || (payload === null || payload === void 0 ? void 0 : payload._id) || null;
    } catch (error) {
...
const getCartKey = ()=>{
    ...
    return userId ? "cart_".concat(userId) : "cart_guest";
};
...
const CartProvider = (param)=>{
    ...
    const [cartItems, setCartItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "CartProvider.useState": ()=>readCart()
    ...
    const [currentUserId, setCurrentUserId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "CartProvider.useState": ()=>decodeToken()
    }["CartProvider.useState"]);
    ...
    const addToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[addToCart]": (food, restaurantId)=>{
            setCartItems({
                "CartProvider.useCallback[addToCart]": (prev)=>{
                    var _ref;
                    const identityRestaurant = (_ref = restaurantId !== null && restaurantId !== void 0 ? restaurantId : food.restaurantId) !== null && _ref !== void 0 ? _ref : null;
                    const foodId = typeof food._id === "string" && food._id.length > 0 ? food._id : null;
                    const existingIndex = prev.findIndex({
                        "CartProvider.useCallback[addToCart].existingIndex": (item)=>{
                            ...
                            if (!foodId) {
                                ...
                                var _item_restaurantId;
                                const itemRestaurant = (_item_restaurantId = item.restaurantId) !== null && _item_restaurantId !== void 0 ? _item_restaurantId : null;
                                var _food_restaurantId;
                                const foodRestaurant = identityRestaurant !== null && identityRestaurant !== void 0 ? identityRestaurant : (_food_restaurantId = food.restaurantId) !== null && _food_restaurantId !== void 0 ? _food_restaurantId : null;
    ...
    const removeFromCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[removeFromCart]": (foodId)=>{
            setCartItems({
                "CartProvider.useCallback[removeFromCart]": (prev)=>prev.filter({
                        "CartProvider.useCallback[removeFromCart]": (item)=>item._id !== foodId
    ...
    const updateQuantity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[updateQuantity]": (foodId, quantity)=>{
            setCartItems({
                "CartProvider.useCallback[updateQuantity]": (prev)=>{
                    if (quantity <= 0) {
                        return prev.filter({
                            "CartProvider.useCallback[updateQuantity]": (item)=>item._id !== foodId
...
_s(CartProvider, "HpibPM5AMZXIlNMzfvl/Z6qx5x4=");
_c = CartProvider;
var _c;
...
const Providers = (param)=>{
    let { children } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$pages$2f$contexts$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CartProvider"], {
        children: children
    }, void 0, false, {
...
//# sourceMappingURL=_50d5ba5d._.js.map