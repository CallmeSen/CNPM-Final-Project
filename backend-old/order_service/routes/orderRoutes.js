...
router.get("/", protect, authorizeRoles("customer", "restaurant", "superAdmin"), getOrders);
router.get("/:id", protect, authorizeRoles("customer", "restaurant", "superAdmin"), getOrderById);
